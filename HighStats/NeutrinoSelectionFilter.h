...
// Wed Jul 12 11:03:10 2023 by ROOT version 6.12/06
// from TTree NeutrinoSelectionFilter/Neutrino Selection TTree
// found on file: /uboone/data/users/apapadop/searchingfornues/high_stat_prodgenie_bnb_nu_overlay_DetVar_Run1_Overlay_MeV_Scale_reco2_reco2.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uboone/data/users/apapadop/searchingfornues/high_stat_prodgenie_bnb_nu_overlay_DetVar_Run1_Overlay_MeV_Scale_reco2_reco2.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/uboone/data/users/apapadop/searchingfornues/high_stat_prodgenie_bnb_nu_overlay_DetVar_Run1_Overlay_MeV_Scale_reco2_reco2.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/uboone/data/users/apapadop/searchingfornues/high_stat_prodgenie_bnb_nu_overlay_DetVar_Run1_Overlay_MeV_Scale_reco2_reco2.root:/nuselection");

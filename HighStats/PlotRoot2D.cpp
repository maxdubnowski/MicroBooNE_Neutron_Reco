...
void PlotRoot2D() {
	...
	PlotNames.push_back("AssociatedBlipMultVsVertexDistAllNeutron_AllEvents");
	PlotNames.push_back("AssociatedBlipMultVsVertexDistAllNeutron_CC1p0piEvent");
	PlotNames.push_back("AssociatedBlipMultVsVertexDistAllNeutron_nonCC1p0piEvent");
	
	// PlotNames.push_back("AssociatedBlipMultVsVertexDistOverNeutron3_AllEvents");
	// PlotNames.push_back("AssociatedBlipMultVsVertexDistOverNeutron3_CC1p0piEvent");
	// PlotNames.push_back("AssociatedBlipMultVsVertexDistOverNeutron3_nonCC1p0piEvent");
	...
	// PlotNames.push_back("AssociatedBlipMultVsProxTrkDistAllNeutron_AllEvents");
	// PlotNames.push_back("AssociatedBlipMultVsProxTrkDistAllNeutron_CC1p0piEvent");
	// PlotNames.push_back("AssociatedBlipMultVsProxTrkDistAllNeutron_nonCC1p0piEvent");
	
	// PlotNames.push_back("AssociatedBlipMultVsProxTrkDistOverNeutron3_AllEvents");
	// PlotNames.push_back("AssociatedBlipMultVsProxTrkDistOverNeutron3_CC1p0piEvent");
	// PlotNames.push_back("AssociatedBlipMultVsProxTrkDistOverNeutron3_nonCC1p0piEvent");
